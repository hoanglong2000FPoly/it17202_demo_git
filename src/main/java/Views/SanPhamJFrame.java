...
import Services.TheLoaiSanPhamDAO;
...
return spform.listSanPham();
   ...
   public void namSanxuat(){
       int a = 2010;
       
       for (int i = 0; i < 2022-2010; i++) {
           model2.addElement(a++);
       }
       cmxNamSanXuat.setModel(model2);
   }
   ...
   public void loadTable(List<SanPham> lst){
    ...
    private void initComponents() {
        ...
        cmxNamSanXuat = new javax.swing.JComboBox<>();
        ...
        cmxNamSanXuat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmxNamSanXuat, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            ...
            Logger.getLogger(SanPhamJFrame.class.getName()).log(Level.SEVERE, null, ex);
             JOptionPane.showMessageDialog(this,"Nhập đúng số");
        }
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        cmxNamSanXuat.setSelectedItem(sp.getNamSanXuat());
    ...
    private javax.swing.JComboBox<String> cmxNamSanXuat;
